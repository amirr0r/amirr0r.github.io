...
tags: [htb-linux-easy, OpenNetAdmin, RCE, reverse-shell, linpeas, plain text password, MySQL, password "cracking", hashcat, ssh port forwarding, ssh2john, John The Ripper, sudo weak configuration, gtfobins, nano, writeup, oscp-prep]
